...
FROZEN_LAKE = {
    ...
    'embedding': [16, 4, (4,)],
    'seed': 200,
    'weight_path' : 'models/frozen_lake_ddqn_dueling.hdf5',
    ...
    'checkpoint_path': 'checkpoints/frozen_lake_ddqn_dueling.json',
    'layers' : [16, 32, 16],
    'dueling' : True,
    'success_average' : 0.7,
    'avg_plot' : True,
